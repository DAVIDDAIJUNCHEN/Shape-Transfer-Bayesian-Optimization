...
def d2t_1d_function(x, 
                    alpha1: float = 1.7, beta1: float = 0.5, 
                    alpha2: float = 0.0, beta2: float = 5.0,
                    alpha3: float = 0.8, beta3: float = 9.5, 
...
def d2t_1d(alpha1: float = None, beta1: float = None, 
    ...
    return partial(d2t_1d_function, 
